...
<div class="container">
    ...
    <main class="main-content">
        ...
        <div class="section-container">
            <div class="section-tab active" data-section="donations">Donations</div>
            <div class="section-tab" data-section="recycled-ideas">Recycled Ideas</div>
        </div>
        <div id="donations" class="content-section active">
            ...
            <div class="available">
                ...
                <div class="available-item">
                    ...
                    <div class="item-time"><?= htmlspecialchars($donation['donated_at']) ?></div>
        ...
        <div id="recycled-ideas" class="content-section">
            <div class="categories">
                <div class="category-scroll-container">
                    <ul class="category-list">
                        <li class="active">All</li>
