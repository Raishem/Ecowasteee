    ...
    <main class="main-content">
        ...
        <div class="project-form">
            <div class="form-group">
                ...
                <input type="text" id="project-name" placeholder="Enter project name (e.g. Plastic Bottle Vase)">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="materials-list" id="materials-list">
                    <div class="material-item">
                        <input type="text" placeholder="Type of material">
...
<script>
    ...
    document.getElementById('add-material').addEventListener('click', function() {
        ...
        newMaterial.innerHTML = `
            <input type="text" placeholder="Type of material">
            <input type="number" placeholder="Quantity" min="1">
            <button type="button" class="btn btn-secondary remove-material" style="padding: 5px 10px; font-size: 12px;">
